    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-card rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          ...
          <button
            onClick={onClose}
            className="text-muted-foreground00 hover:text-muted-foreground00 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="border border-border rounded-lg p-4">
              ...
              <ul className="text-sm text-foreground00 space-y-1 ml-4">
              ...
              <p className="text-xs text-muted-foreground00 mt-2 italic">Helps us understand which models users prefer</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4">
              ...
              <p className="text-xs text-muted-foreground00 mt-2 italic">Helps us optimize performance and understand usage patterns</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4">
              ...
              <p className="text-xs text-muted-foreground00 mt-2 italic">Helps us improve compatibility, NOT the actual device names</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4">
              ...
              <p className="text-xs text-muted-foreground00 mt-2 italic">Helps us improve user experience</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4">
              ...
              <p className="text-xs text-muted-foreground00 mt-2 italic">Helps us prioritize platform support</p>
            </div>
          </div>
          ...
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            ...
            <pre className="text-xs text-foreground00 overflow-x-auto">
              {`{
  "event": "meeting_ended",
  "app_version": "0.3.0",
