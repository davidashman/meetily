...
export const AISummary = ({ summary, status, error, onSummaryChange, onRegenerateSummary, meeting }: Props) => {
  ...
  const renderErrorState = () => (
    <div className="w-full p-4 bg-red-900/30 border border-red-800 rounded-lg">
      <div className="flex items-center mb-2">
        <ExclamationTriangleIcon className="h-5 w-5 text-red-400 mr-2" />
        <h3 className="text-red-400 font-medium">Error Generating Summary</h3>
      </div>
  ...
  const renderLoadingState = () => (
    <div className="w-full p-4 bg-blue-900/30 border border-blue-800 rounded-lg">
